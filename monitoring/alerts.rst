...
By default |conduit| provides email notification services using the `conduitdata.com` email address. It may be advisable to customize these services to use another mail delivery service.
