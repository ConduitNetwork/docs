...
The Key Pairs section enables the following actions: Add and Delete key pairs. Key Pairs are commonly used by |conduit| for accessing instances via SSH. |conduit| stores key pairs to simplify administration and access across both private and public clouds.
